...
> 3. 精准投放——根据大数据与机器学习建立账户分级机制。广告主可通过推广链数据分析平台确定投放范围，明确目标用户特征
...
“推广链”（ProChain）是一个基于以太坊的去中心化营销推广区块链，该平台的统一代币称为推广币（PRO）。广告主通过推广链智能合约建立营销任务，推广员完成任务并实时结算奖金。推广链将用户注意力产生的价值归还于用户本身，致力于创造“推广即营销”的病毒传播模式


#### 2.推广币是否可转给其他人，何时上市交易？
推广币（PRO）符合以太坊ERC20代币标准，可通过以太坊区块链开展交易，我们将在推广币众筹完成后上架主流数字货币交易所。


#### 3.推广币如何使用？
广告主（Advertiser）可通过参与ICO或公开市场采购推广币（PRO），并将PRO注入智能合约并用于建立营销任务；完成任务的推广员（Promoter）将根据任务价格以及个人传播力获得相应的推广币作为酬劳。


#### 4.在钱包里如何看到我的推广币？
ICO结束后，在任意一个具有以太币交易功能的钱包中，在“观察合约”处添加推广币合约地址即可显示
...
18Q1：去中心化任务分发应用上线，推广链进入正式运营
18Q2：桌面端、移动端等客户端落地
18Q3：去中心化任务流功能部署上线，智能推荐任务


#### 7.推广链的机制是不是传销，有何不同？
不是传销，推广链与传销机制差异巨大：传销组织具有显著的金字塔特性，越高层级的成员可以获得越高比例的分成，成员等级往往高达8~10层。而推广链秉承区块链去中心化特性，用户层级是扁平化的。具体来说，每个账户仅可传播任务至自己的朋友圈，经某个朋友再次传播并完成的任务并不会给原账户带来收益，只会为该朋友带来收益。推广链的任务传播机制更像是邀请码分发的形式。


#### 8.推广币的众筹计划是怎样的？

推广币总计发行100亿个，ICO众筹时间为期30天，预计发放代币数量60亿个。众筹目标金额为40000ETH，最低筹款额20000ETH，在ICO期间一旦筹满40000ETH则众筹环节直接结束。未达到40000但超过20000，则按照注入ETH总数来计算对应投资者份额，根据份额来分配全部60亿推广币。

在筹满4万ETH的前提下，每1个ETH可兑换150000个PRO；而如果筹到3万ETH，则每个ETH可兑换200000个PRO；如果众筹结束时刚好达到2万ETH最低筹款额，则每个ETH可兑换300000个PRO


#### 9.推广币的合约地址是？
我们将在ICO发布之后，通过推广链各个认证渠道通知各位投资者
...
#### 11.推广链如何对应广告欺诈？
推广链拥有独有的POSt机制，通过区块链特性对广告欺诈予以彻底的消除。POSt机制是基于账户持币数量与持币时间的一种综合方案，具体来说一个账户在领取任务的时候，将POSt权重作为一个账户是否可领取任务的阈值。POSt具体计算方式为：持币数量×持币秒数。也就是说，某个希望领取任务的账户，需要持有推广币，并且需要保证这部分推广币在一定时间段内没有交易。POSt机制可有效阻止机器人账号批量刷任务。当某个账户完成特定任务后，该账户下POSt权重将归零并重新计算。而价值越高的任务，对领取任务账号的POSt权重要求也会越高


#### 12.什么时候可以领取推广币？
当ICO众筹结束后，我们将通过ICO平台为大家发放推广币
