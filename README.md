...
> 1. 智能结算——通过以太坊区块链部署的智能合约实现实时结算，避免账目延期或陷入合同纠纷
> 2. 去中介化——通过区块链去中心化特性，消除广告投放资金中不低于25%的中介成本，节省广告主资金，提高广告参与者收入
> 3. 精准投放——根据大数据与机器学习建立账户分级机制。广告主可通过般若数据分析平台确定投放范围，明确目标用户特征
> 4. 消灭欺诈——通过区块链独有的POSt机制，彻底消除广告欺诈风险
...
“般若链”（ProChain）是一个基于以太坊的大数据精准营销区块链，该平台的统一代币称为般若币（PRO）。广告主通过般若链智能合约建立营销任务，推广员完成任务并实时结算奖金。般若链将用户注意力产生的价值归还于用户本身，致力于创造“推广即营销”的病毒传播模式
  
  

#### 2.般若币是否可转给其他人，何时上市交易？
般若币（PRO）符合以太坊ERC20代币标准，可通过以太坊区块链开展交易，我们将在般若币众筹完成后上架主流数字货币交易所。
  
  

#### 3.般若币如何使用？
广告主（Advertiser）可通过参与ICO或公开市场采购般若币（PRO），并将PRO注入智能合约并用于建立营销任务；完成任务的推广员（Promoter）将根据任务价格以及个人传播力获得相应的般若币作为酬劳。


#### 4.在钱包里如何看到我的般若币？
ICO结束后，在任意一个具有以太币交易功能的钱包中，在“观察合约”处添加般若币合约地址即可显示
...
#### 6.般若链的开发蓝图是什么？
17Q4：Beta测试上线，定向邀请广告主与推广员试用
18Q1：去中心化任务分发应用上线，般若链进入正式运营
18Q2：桌面端、移动端等客户端落地
18Q3：去中心化任务流功能部署上线，智能推荐任务


#### 7.般若链的机制是不是传销，有何不同？
不是传销，般若链与传销机制差异巨大：传销组织具有显著的金字塔特性，越高层级的成员可以获得越高比例的分成，成员等级往往高达8~10层。而般若链秉承区块链去中心化特性，用户层级是扁平化的。具体来说，每个账户仅可传播任务至自己的朋友圈，经某个朋友再次传播并完成的任务并不会给原账户带来收益，只会为该朋友带来收益。推般若链的任务传播机制更像是邀请码分发的形式。
...
#### 9.般若币的合约地址是？
我们将在ICO发布之后，通过般若链各个认证渠道通知各位投资者


#### 10.我在哪里可以看到般若链项目白皮书？
中文地址：[白皮书](https://github.com/ProChain/WhitePaper/blob/master/般若白皮书20170822.pdf)
英文地址：[Whitepaper](https://github.com/ProChain/WhitePaper/blob/master/ProChain%20WhitePaper0822.pdf)


#### 11.般若链如何对应广告欺诈？
般若链拥有独有的POSt机制，通过区块链特性对广告欺诈予以彻底的消除。POSt机制是基于账户持币数量与持币时间的一种综合方案，具体来说一个账户在领取任务的时候，将POSt权重作为一个账户是否可领取任务的阈值。POSt具体计算方式为：持币数量×持币秒数。也就是说，某个希望领取任务的账户，需要持有般若币，并且需要保证这部分PRO币在一定时间段内没有交易。POSt机制可有效阻止机器人账号批量刷任务。当某个账户完成特定任务后，该账户下POSt权重将归零并重新计算。而价值越高的任务，对领取任务账号的POSt权重要求也会越高
...
17Q4: Beta test, inviting advertisers and promoters for trial
18Q1: ProChain officially released. Marketing quests distribution Dapp published
18Q2: Desktop clients and mobile clients landing
18Q4: Decentralized Quest Flow deploys. Intelligent quest recommendation for users


#### 7.Is ProChain a pyramid scheme?
...
#### 10.why don't we choose the smart contract of Ethereum to crowdfund？
...
English Address: [Whitepaper](https://github.com/ProChain/WhitePaper/blob/master/ProChain%20WhitePaper0822.pdf)
